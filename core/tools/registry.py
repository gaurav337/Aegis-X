...
_TOOL_MANIFEST = [
    ("check_c2pa",       "core.tools.c2pa_tool",         "C2PATool",         0.05, ToolCategory.PROVENANCE,  2),
    ("run_rppg",         "core.tools.rppg_tool",         "RPPGTool",         0.08, ToolCategory.BIOLOGICAL,  2),
    ("run_dct",          "core.tools.dct_tool",          "DCTTool",          0.07, ToolCategory.FREQUENCY,   1),
    ("run_geometry",     "core.tools.geometry_tool",     "GeometryTool",     0.20, ToolCategory.GEOMETRIC,   3),
    ("run_illumination", "core.tools.illumination_tool", "IlluminationTool", 0.05, ToolCategory.FREQUENCY,   1),
    ("run_corneal",      "core.tools.corneal_tool",      "CornealTool",      0.08, ToolCategory.BIOLOGICAL,  2),
    ("run_siglip_adapter","core.tools.siglip_adapter_tool","SiglipForensicAdapter", 0.17, ToolCategory.SEMANTIC, 2),  # FIXED
    ("run_sbi",          "core.tools.sbi_tool",          "SBITool",          0.20, ToolCategory.GENERATIVE,  3),
    ("run_freqnet",      "core.tools.freqnet_tool",      "FreqNetTool",      0.10, ToolCategory.FREQUENCY,   1),
]
