...
SBI_SCALE_115 = 1.15
SBI_SCALE_125 = 1.25
SBI_CONFIDENCE_THRESHOLD = 0.7      # FIX: Missing constant
...
# =============================================================================
# SIGLIP ADAPTER THRESHOLDS
# =============================================================================

SIGLIP_FAKE_THRESHOLD = 0.65
SIGLIP_REAL_THRESHOLD = 0.35
SIGLIP_CONFIDENCE_SCORE = 0.90
SIGLIP_CONFIDENCE_MIN = 0.5       # FIX: Missing constant
SIGLIP_BATCH_SIZE = 32            # FIX: Missing constant
SIGLIP_TTA_ENABLED = True
SIGLIP_TTA_METHOD = "MAX"
SIGLIP_LSE_BETA_INIT = 1.0
SIGLIP_HOOK_BLOCKS = [3, 6, 9, 11]
SIGLIP_PRECISION = "MIXED_FP16_FP32"
SIGLIP_CROPS = 6
SIGLIP_PATCH_SIZE = 16
SIGLIP_TOKENS = 196
SIGLIP_HIDDEN_DIM = 768
SIGLIP_MODEL_PATH = "models/siglip_forensic.pt"
